...
async def get_commodity_analytics(commodity: str, kpi_type: str = "overall"):
    ...
    try:
        ...
        try:
            ...
            # For now, just return the pandas data without Spark fallback
            raise HTTPException(
                status_code=500,
                detail=f"Error loading analytics data: {str(e)}"
            )
...
async def get_etl_status():
    ...
    try:
        ...
        manual_log_file = "data/analytics/manual_etl_log.json"
